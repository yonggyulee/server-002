...
public class UpdateObjectDetectionGtHandler : GtDatasetHandler, IRequestHandler<UpdateObjectDetectionGtCommand, ObjectDetectionGt>
{
    private readonly RequesterContext _requesterContext;
    public UpdateObjectDetectionGtHandler(IDbContextFactory<DatasetDbContextPostgreSQL> dbContextFactory,
        IPostgresLockProviderFactory lockProviderFactory, ILogger<UpdateObjectDetectionGtHandler> logger,
    ...
    public async Task<ObjectDetectionGt> Handle(UpdateObjectDetectionGtCommand command, CancellationToken cancellationToken)
    {
        ...
        var selectedGt = await _dbContext.ObjectDetectionGts
                             ...
                             .SingleOrDefaultAsync(od => od.Id == request.Id,
                                 cancellationToken)
        ...
        var originGt = _mapper.From(selectedGt).AdaptToType<ObjectDetectionGtEntity>();
        ...
        catch
        {
            ...
            await _fileStorage.SaveFileAsync(originDatasetUri, originGt.Filename, originGt.Buffer, cancellationToken);
            throw;
        }
