...
public class UpdateObjectDetectionGtDatasetHandler : GtDatasetHandler, IRequestHandler<UpdateObjectDetectionGtDatasetCommand, ObjectDetectionGtDataset>
{
    private readonly RequesterContext _requesterContext;
    public UpdateObjectDetectionGtDatasetHandler(IDbContextFactory<DatasetDbContextPostgreSQL> dbContextFactory,
        IPostgresLockProviderFactory lockProviderFactory, ILogger<UpdateObjectDetectionGtDatasetHandler> logger,
    ...
    public async Task<ObjectDetectionGtDataset> Handle(UpdateObjectDetectionGtDatasetCommand command, CancellationToken cancellationToken)
    {
