...
namespace Mirero.DAQ.Test.Integration.Service.Update;

public class UpdateApiServiceFixture : ApiServiceFixture
{
    public UpdateApiServiceFixture() : base(
...
public class UpdateServiceIntegrationTestFixtures : ICollectionFixture<UpdateApiServiceFixture>
{   
}