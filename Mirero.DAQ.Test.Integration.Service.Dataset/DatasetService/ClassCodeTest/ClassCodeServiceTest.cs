...
public partial class ClassCodeServiceTest
{
    ...
    private readonly Domain.Dataset.Protos.V1.ClassCodeService.ClassCodeServiceClient _client;
    //private readonly AccountService.AccountServiceClient _accountServiceClientclient;

    public ClassCodeServiceTest(DatasetApiServiceFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
        _scope = fixture.Host!.Services.CreateScope();
        //_accountServiceClientclient = _fixture.AccountService;
        _client = new Domain.Dataset.Protos.V1.ClassCodeService.ClassCodeServiceClient(_fixture.GrpcChannel);
    }
