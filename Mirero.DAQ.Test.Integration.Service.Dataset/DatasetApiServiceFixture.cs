...
namespace Mirero.DAQ.Test.Integration.Service.Dataset;

public class DatasetApiServiceFixture : ApiServiceFixture
{
    public DatasetApiServiceFixture() : base(
...
[CollectionDefinition("DatasetIntegrationTest")]
public class DatasetServiceIntegrationTestFixtures : ICollectionFixture<DatasetApiServiceFixture>
{   
}